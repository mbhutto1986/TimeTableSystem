...
public final class TeacherDataOperations
{
	...
	// Method that add Teacher record in teacher table
	public static long addTeacher(Department department, String teacherName, String teacherNicNumber, String teacherHomePhone, String teacherOfficePhone, String teacherMobilePhone, String teacherEmail, String teacherQualifications, String teacherDesignation, byte teacherGrade) throws SQLException, ClassNotFoundException {
		long teacherId = -1 ;
		...
		insertPreparedStatement.setLong(1, department.getDepartmentID())				;
		insertPreparedStatement.setString(2,teacherName.trim())				;
		insertPreparedStatement.setString(3,teacherNicNumber.trim())		    ;
		insertPreparedStatement.setString(4,teacherHomePhone.trim())			;
		insertPreparedStatement.setString(5,teacherOfficePhone.trim())		;
		insertPreparedStatement.setString(6,teacherMobilePhone.trim())		;
		insertPreparedStatement.setString  (7,teacherEmail);					;
		insertPreparedStatement.setString(8,teacherQualifications.trim())	;
		insertPreparedStatement.setString(9,teacherDesignation.trim())		;
		insertPreparedStatement.setByte  (10,teacherGrade)					;
	...
	/*		for(int j=0; j<records.length; j++)
			{
				System.out.print(subRecords[j][0]);    System.out.print("    ");
				System.out.print(subRecords[j][1]);    System.out.print("    ");
				System.out.print(subRecords[j][2]);    System.out.print("    ");
				System.out.print(subRecords[j][3]);    System.out.print("    ");
				System.out.print(subRecords[j][4]);	   System.out.print("    ");
				System.out.print(subRecords[j][5]);    System.out.print("    ");
				System.out.print(subRecords[j][6]);    System.out.print("    ");
				System.out.print(subRecords[j][7]);    System.out.println("    ");
	...
	// Method that delete Teacher record from teacher table
	public static int deleteTeacher(Long id) throws SQLException, ClassNotFoundException {
	...
	// Method that search Teacher record in teacher table
	...
	public static int updateTeacher(long teacherId, Department department, String teacherName, String teacherNicNumber, String teacherHomePhone, String teacherOfficePhone, String teacherMobilePhone, String teacherEmail, String teacherQualifications, String teacherDesignation, byte teacherGrade) throws SQLException, ClassNotFoundException
	{
		...
		updatePreparedStatement.setLong(1,department.getDepartmentID())						;
		updatePreparedStatement.setString(2,teacherName.trim())						;
		updatePreparedStatement.setString(3,teacherNicNumber.trim())				;
		updatePreparedStatement.setString(4,teacherHomePhone.trim())				;
		updatePreparedStatement.setString(5,teacherOfficePhone.trim())			;
		updatePreparedStatement.setString(6,teacherMobilePhone.trim())			;
		updatePreparedStatement.setString(7,teacherEmail.trim())					;
		updatePreparedStatement.setString(8,teacherQualifications.trim())			;
		updatePreparedStatement.setString(9,teacherDesignation)					  	;
		updatePreparedStatement.setByte  (10,teacherGrade)							;
		updatePreparedStatement.setLong   (11,teacherId)			  				;
